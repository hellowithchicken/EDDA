...
H_{B}:\beta_{j} = 0 for every j (no main effect of factor B)
 ...
 We see that the humidity:environment column in the Anova test shows a significant p-value of 3.7e-07 which means that the there is evidence for the interaction effect between humidity and environment. 
