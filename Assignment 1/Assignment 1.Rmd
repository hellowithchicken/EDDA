...
From summary statistics it seems that "sunflower" feed is the feed resulting in highest weight, however by looking at the p-values we can see that it is not significantly different from base feed variety, therefore we cannot conclude which one is the best.
