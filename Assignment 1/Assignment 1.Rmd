...
```
 ...
 The results show a 95% confidence interval between 24.80 and 32.97 which is a narrow confidence interval. It also shows a different confidence interval than the bootstrap confidence interval which can be explained because of the random nature of the bootstrap.
