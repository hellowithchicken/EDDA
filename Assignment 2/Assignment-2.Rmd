...
```
The test shows a p-value o 0.04 which is significant as it is lower than our $\alpha$-value of 0.05. This means that the $H_0$ can be rejected and we can state that there is a significant effect of the interface. 
