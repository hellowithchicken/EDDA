...
paste0("Optimal lambda value: ", round(opt_Lambda, 4))
...
summary_table <- data.frame(summary(chickaov)$coefficients) %>% 
  rename("p-value" = `Pr...t..`) %>% 
  add_rownames("Type") %>% 
  mutate(Type = case_when(
    ...
    Type != "feedcasein" ~ as.numeric(summary_table$Estimate[1]) + Estimate,
    TRUE ~ Estimate
  ))
knitr::kable(summary_table, "latex", align = "c")
